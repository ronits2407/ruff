...
reveal_type(generic_context(factory()))  # revealed: ty_extensions._internal.GenericContext[T'return@factory, U'return@factory]
...
reveal_type(generic_context(first))  # revealed: ty_extensions._internal.GenericContext[T'return@pair_factory]
reveal_type(generic_context(second))  # revealed: ty_extensions._internal.GenericContext[T'return@pair_factory]
...
reveal_type(generic_context(recursive_factory()))  # revealed: ty_extensions._internal.GenericContext[T'return@recursive_factory]
```
